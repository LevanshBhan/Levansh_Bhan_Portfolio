...
export const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+49 15510450589",
      href: "tel:+4915510450589"
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // EmailJS integration
      const serviceId = 'service_c9l61yh';
      const templateId = 'template_ybyfdp1';
      const publicKey = 'iBARkMpKKqxXi_BEK'; // <-- Replace with your EmailJS public key
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <RevealOnScroll>
            ...
            >
              {/* Availability Status */}
              <motion.div 
                className="bg-black/20 backdrop-blur-sm border border-cream/10 rounded-xl p-6 hover:border-cream/30 transition-all duration-300"
                whileHover={{ y: -2 }}
